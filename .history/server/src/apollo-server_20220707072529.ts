...
export async function createApolloServer(
  ...
  const server = new ApolloServer({
    ...
    context: (): TwitterResolverContext => ({ db, thing }), //context (express-concept) object always available in any of our resolvers (one of the arguments you automatically get)
