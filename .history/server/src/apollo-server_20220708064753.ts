...
export async function createApolloServer( ///these are the arguments for the ApolloServer constructor
  ...
  const server = new ApolloServer({
    ...
    context: (): TwitterResolverContext => ({ db, dbTweetCache, dbTweetToFavoriteCountMap, }), //context (express-concept) object always available in any of our resolvers (one of the arguments you automatically get)
