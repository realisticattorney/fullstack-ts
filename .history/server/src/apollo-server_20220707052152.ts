...
export async function createApolloServer(
  ...
  const server = new ApolloServer({
    ...
    //we'll use it as a memory to store data from one method from the Query resolver to another (like finding a tweet but then use that twwet id to find its users )
    plugins: [
