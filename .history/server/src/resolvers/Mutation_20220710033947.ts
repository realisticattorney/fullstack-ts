...
//OK, I know why. The tweet is sent, sure, and from this resolver we go into the Tweet resolvers indeed. HOWEVER, the time I've got the authors for the tweets, I was running the tweets resolvers before the Tweet resolver, 