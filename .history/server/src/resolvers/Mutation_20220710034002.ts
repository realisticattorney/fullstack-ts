...
//OK, I know why. The tweet is sent, sure, and from this resolver we go into the Tweet resolver indeed. HOWEVER, the time I've got the authors for the tweets, I was running the tweets resolvers before the Tweet resolver, and tweets resolvers makes a call to the database to get the authors. So, the authors are not yet in the cache.