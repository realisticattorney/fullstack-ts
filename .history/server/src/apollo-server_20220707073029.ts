...
//from what I guess, the context object interface was set on resolvers.ts, the I don't need to put a ! on TS to say hey, that's mandatory.. So when I added a thing: any[]