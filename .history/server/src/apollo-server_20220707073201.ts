...
//and I was able to use that thing array on the resolvers (again, from the third argument which is the context object) aaand, the thing, being an array, already offered me the 