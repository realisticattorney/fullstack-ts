...
export type CreateTweetMutation = {
  __typename?: 'Mutation';
  createTweet: { __typename?: 'Tweet'; id: string; body: string };
};
...
>;
export type CreateTweetMutationResult =
  Apollo.MutationResult<CreateTweetMutation>;
 ...
 * });
 */
export function useGetAllTweetsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAllTweetsQuery,
    GetAllTweetsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAllTweetsQuery, GetAllTweetsQueryVariables>(
    GetAllTweetsDocument,
    options
  );
}
export function useGetAllTweetsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllTweetsQuery,
    GetAllTweetsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetAllTweetsQuery, GetAllTweetsQueryVariables>(
    GetAllTweetsDocument,
    options
  );
}
export type GetAllTweetsQueryHookResult = ReturnType<
  typeof useGetAllTweetsQuery
>;
export type GetAllTweetsLazyQueryHookResult = ReturnType<
  typeof useGetAllTweetsLazyQuery
>;
export type GetAllTweetsQueryResult = Apollo.QueryResult<
  GetAllTweetsQuery,
  GetAllTweetsQueryVariables
>;
