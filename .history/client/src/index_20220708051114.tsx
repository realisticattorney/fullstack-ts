...
//when in this interface for the resolvers we say that certain resolver should return a certain type OR A PROMISE THAT RESOLVER INTO A CERTAIN TYPE, we can use the type information that we've generated for the types that we've defined in the schema.
