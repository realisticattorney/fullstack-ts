...
//the schema (gql`...` //in a tag template literal) describes our types and our queries. So on one hand it has the equivalent of the set of interfaces in typescript. But it also has the type Query, which is equivalent as to state the HTTP VERBS in REST APIs. So the 
