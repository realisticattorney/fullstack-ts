...
//then we import an interface for the db object (instance of DB class) as we put it as the returned value of the resolvers and of the so that we have the methods in autocompletion.
