...
//context can be a cb function, returning a clean, stateless object every time, or just an stateful object. I don't think this has to do with modifying the db, of course you can modify it even if your context is cb function. The difference I guess is that the thing you reference to and save in this object aside from the db { db, references: { ... } } will be persistent accross different requests.
