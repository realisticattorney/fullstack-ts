...
//each resolver function has to match the schema's with one of the query types (eg.: Query { [queryType]: Entity }. The resolver has to return the Entity type specified 
