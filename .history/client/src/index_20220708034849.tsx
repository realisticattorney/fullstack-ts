...
//!!!!
//The types for entities (etype User) are used to create the models that will be stored in the database. The types for the properties of the type Query are used to specify the fields that will be exposed in the GraphQL API.
//!!!!
