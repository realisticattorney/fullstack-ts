...
//then we import an interface for the db object (instance of DB class) and put it on a new interface where the DB as we put it as the returned value of the resolvers so that we have the methods in autocompletion. resolvers: Resolvers<TwitterResolverContext>
