...
//so right now I have the .graphql schema loaded in my Apollo server, checking the types of whatever I return from the resolvers (runtime checks) but I dont have anything that checks we
