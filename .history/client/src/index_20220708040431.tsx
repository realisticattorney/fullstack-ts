...
//we don't have any resolvers yet, but we do have a schema. The schema, at runtime (when there's an incoming request for the query currentUser for example), will be used to generate the types for the entities and the properties of the type Query.
