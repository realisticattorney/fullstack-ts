...
//so our test query failed. Now will make the resolvers. These functions reads parts of the requests (equivalent to the /:id, for instance, and the function itself would be like GET /user, for instance). So each resolver is a small part of a query as a user might ask for 
