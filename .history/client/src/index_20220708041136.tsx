...
//so our test query failed. Now will make the resolvers. These functions reads parts of the requests (equivalent to the /:id, for instance, and the funciton itself would be like GET /user, for instance)
