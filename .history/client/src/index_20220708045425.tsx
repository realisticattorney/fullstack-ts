...
//Resolvers. Yes, we have the db taken from the context, and we can call the db methods on it to get certain parts of the database. Then do somthing more and return data. In between, add some of it as a reference to the context object, likely temporarely, 
