...
//this file of generated resolver-types has a mapping from the graphql types to the typescript types. So when I call the resolvers, I can use the types that I've generated for the types that I've defined in the schema.
