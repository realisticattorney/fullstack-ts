...
//the context is both a reference/a way to pass the db to the resolvers so as to access the database and manipulate it base of the request, and the params of the request, if any. BUT WE CAN ALSO 
