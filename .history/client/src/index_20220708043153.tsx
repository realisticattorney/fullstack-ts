...
//we strip our schema out of that tagged template string and put it in a file at the root of the project as it will be used by the client side app as well. And we make that schema a .graphql file to gain more functionality that gets difficult to use 
