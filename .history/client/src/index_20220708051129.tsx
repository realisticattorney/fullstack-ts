...
//when in this interface for the resolvers we say that certain resolver should return a certain type OR A PROMISE THAT RESOLVER INTO A CERTAIN TYPE, it's telling us we can make an ASYNC 
