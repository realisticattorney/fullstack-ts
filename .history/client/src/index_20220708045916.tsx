...
//then we import an interface for the db object (instance of DB class) as we put it as the returned value of the resolvers so that we have the methods in autocompletion. resolvers: Resolvers<Tw
