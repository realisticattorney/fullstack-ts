...
//we don't have any resolvers yet, but we do have a schema. The schema, at runtime (when there's an incoming request for the query currentUser for example), will check that I can't return a non nullable field and that's the error. 
