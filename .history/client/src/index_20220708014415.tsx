...
//there's a codegen.yml file for this in the server folder. and another one for the client folder. in the servers I have a pluging for typescript-resolvers