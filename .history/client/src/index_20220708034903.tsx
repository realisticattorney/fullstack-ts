...
//!!!!
//The types for entities (eg. type User) are used to create the models that will be stored in the database. The types for the properties of the type Query (currentUser) are used to specify the fields that will be exposed in the GraphQL API.
//!!!!
